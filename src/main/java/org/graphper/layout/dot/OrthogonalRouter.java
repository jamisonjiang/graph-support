...
import org.graphper.layout.OrthoNodeSizeExpander;
...
class OrthogonalRouter extends AbstractDotLineRouter {
  ...
  private void ovgRouter(EdgeSegRecord edgeSegRecord, LineDrawProp lineDrawProp,
    ...
    DNode tail = (DNode) layoutGraph.getNode(lineDrawProp.getLine().tail());
    DNode head = (DNode) layoutGraph.getNode(lineDrawProp.getLine().head());
