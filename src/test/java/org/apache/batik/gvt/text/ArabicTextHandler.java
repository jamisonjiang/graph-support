    ...
    for (int i = 0; i < text.length(); i++) {
      ...
      if (charStartsLigature(c) && (i + 1 < text.length())) {
        ...
        if (form == ARABIC_TERMINAL && nextForm == ARABIC_INITIAL) {
          int substChar = org.graphper.draw.common.ArabicTextHandler.getSubstituteChar(c, nextChar, ARABIC_ISOLATED);
          if (substChar > -1) {
          ...
          int substChar = org.graphper.draw.common.ArabicTextHandler.getSubstituteChar(c, nextChar, ARABIC_TERMINAL);
          if (substChar > -1) {
            substString.append((char) substChar);
            i++;
            continue;
          ...
          int substChar = org.graphper.draw.common.ArabicTextHandler.getSubstituteChar(c, nextChar, ARABIC_MEDIAL);
          if (substChar > -1) {
            substString.append((char) substChar);
            i++;
            continue;
