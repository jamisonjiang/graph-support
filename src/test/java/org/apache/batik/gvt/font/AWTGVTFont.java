...
//        String str = ArabicTextHandler.createSubstituteString(sb.toString());
//
//        return createGlyphVector(frc, str);
//      }
//    }
//    FontRenderContext test = new FontRenderContext(new AffineTransform(), true, true);
//    GlyphVector gv = awtFont.createGlyphVector(frc, sb.toString());
