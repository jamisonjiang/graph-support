 ...
 * @version $Id: AWTGVTGlyphVector.java 1733416 2016-03-03 07:07:13Z gadams $
 */
...
//      System.out.print(" new FlatPoint(" + getGlyphPosition(glyphIndex).getX() + ", " + getGlyphPosition(glyphIndex).getY() + "" + "),");
...
//      glyphOutlines[glyphIndex]=glyphOutline;
    }
...
//    System.out.println("-------------------------------------------");
  ...
  public void draw(Graphics2D graphics2D,
    ...
    graphics2D.setFont(new Font("Aria", Font.PLAIN, 14));
...
//              DocumentUtils.getTestSerialPath() + "GeneralPath", outline,
//              g -> {});
//        } catch (Exception e) {
