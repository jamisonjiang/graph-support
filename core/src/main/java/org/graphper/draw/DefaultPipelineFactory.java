...
/**
 * Default of {@link PipelineFactory}.
 *
...
public class DefaultPipelineFactory implements PipelineFactory {
  ...
  @Override
  public <B extends Brush, T extends NodeEditor<B>> NodePipelineTrigger<B, T> nodeExecutePipeline(
      List<T> editors, DrawGraph graphviz) {
    return new NodePipelineTrigger<>(editors, graphviz);
  }

  @Override
  public <B extends Brush, T extends LineEditor<B>> LinePipelineTrigger<B, T> lineExecutePipeline(
      List<T> editors, DrawGraph graphviz) {
    return new LinePipelineTrigger<>(editors, graphviz);
  }
