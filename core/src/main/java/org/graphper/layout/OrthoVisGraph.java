...
public class OrthoVisGraph {
  ...
  /** Adds both vertices and links the second as the first vertex's left neighbor. */
  ...
  /** Adds both vertices and links the second as the first vertex's right neighbor. */
  ...
  /** Adds both vertices and links the second as the first vertex's top neighbor. */
  ...
  /** Adds both vertices and links the second as the first vertex's bottom neighbor. */
  public void addBottom(GridVertex vertex, GridVertex bottom) {
    Asserts.nullArgument(bottom, "bottom");
    Asserts.nullArgument(vertex, "vertex");
    Asserts.illegalArgument(
        vertex == bottom, "The bottom node cannot be equal to the current node");
    addTop(bottom, vertex);
  }

  /** A rectangular visibility vertex with links in the four orthogonal directions. */
  public static class GridVertex implements Box, Comparable<GridVertex> {
    ...
    /** Creates a visibility vertex bounded by the supplied corners. */
  ...
  /** A segment with distinct, non-null endpoints once assigned. */
  public static class Segment {
    ...
    /** Sets the start point, rejecting null or the current end point. */
    ...
    /** Sets the end point, rejecting null or the current start point. */
