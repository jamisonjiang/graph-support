...
The **mclimit** attribute controls the **maximum constraint relaxation** for crossing minimization in graph layout. It affects how aggressively the algorithm attempts to reduce edge crossings.
...
Graphviz graph = Graphviz.digraph()
    .mclimit(5.0)  // Allows maximum relaxation for crossing minimization
    .addLine(a, b)
    .addLine(b, c)
    .addLine(c, d)
    .build();
